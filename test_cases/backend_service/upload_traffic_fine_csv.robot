...
*** Variables ***
&{text_data_uae}                       serviceProviderId=62a1a6954d402c22610b072c   addOnChargeType=TRAFFIC
&{text_data_ksa}                       serviceProviderId=5f688042012d744e48ed7e89   addOnChargeType=TRAFFIC
...
*** Test Cases ***
Upload Traffic Fine 1 Valid Date, Active Booking, UAE
    [Tags]             URL Cases
...
Upload Traffic Fine 2 Beyond Deadline, Active Booking, UAE
    [Tags]             URL Cases
...
Upload Traffic Fine 3 Valid Date, Force Return, UAE
    [Tags]             URL Cases
...
Upload Traffic Fine 4 Beyond Deadline, Force Return, UAE
    [Tags]             URL Cases
...
Upload Traffic Fine 5 Valid Date, Completed, UAE
    [Tags]             URL Cases
...
# Upload Traffic Fine 6 Beyond Deadline, Completed, UAE
#     [Tags]             URL Cases
...
# Upload Traffic Fine 7 Valid Date, Active Booking, ksa
#     [Tags]             URL Cases
...
# Upload Traffic Fine 8 Beyond Deadline, Active Booking, ksa
#     [Tags]             URL Cases
...
# Upload Traffic Fine 9 Valid Date, Force Return, ksa
#     [Tags]             URL Cases
...
# Upload Traffic Fine 10 Beyond Deadline, Force Return, ksa
#     [Tags]             URL Cases
...
# Upload Traffic Fine 11 Valid Date, Completed, ksa
#     [Tags]             URL Cases
...
# Upload Traffic Fine 12 Beyond Deadline, Completed, ksa
#     [Tags]             URL Cases
