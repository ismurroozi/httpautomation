...
*** Variables ***
&{text_data_uae}                       serviceProviderId=62a1a6954d402c22610b072c   addOnChargeType=EXCEEDED_MILEAGE_CHARGE
&{text_data_ksa}                       serviceProviderId=5f688042012d744e48ed7e89   addOnChargeType=EXCEEDED_MILEAGE_CHARGE
...
*** Test Cases ***
Upload Exceeded Mileage Charges 1 Valid Date, Active Booking, UAE
    [Tags]             URL Cases
...
Upload Exceeded Mileage Charges 2 Beyond Deadline, Active Booking, UAE
    [Tags]             URL Cases
...
Upload Exceeded Mileage Charges 3 Valid Date, Force Return, UAE
    [Tags]             URL Cases
...
Upload Exceeded Mileage Charges 4 Beyond Deadline, Force Return, UAE
    [Tags]             URL Cases
...
Upload Exceeded Mileage Charges 5 Valid Date, Completed, UAE
    [Tags]             URL Cases
...
Upload Exceeded Mileage Charges 6 Beyond Deadline, Completed, UAE
    [Tags]             URL Cases
...
Upload Exceeded Mileage Charges 7 Valid Date, Active Booking, ksa
    [Tags]             URL Cases
...
# Upload Exceeded Mileage Charges 8 Beyond Deadline, Active Booking, ksa
#     [Tags]             URL Cases
...
# Upload Exceeded Mileage Charges 9 Valid Date, Force Return, ksa
#     [Tags]             URL Cases
...
# Upload Exceeded Mileage Charges 10 Beyond Deadline, Force Return, ksa
#     [Tags]             URL Cases
...
Upload Exceeded Mileage Charges 11 Valid Date, Completed, ksa
    [Tags]             URL Cases
...
Upload Exceeded Mileage Charges 12 Beyond Deadline, Completed, ksa
    [Tags]             URL Cases
